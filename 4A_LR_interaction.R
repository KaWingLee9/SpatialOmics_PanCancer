...
source('https://github.com/KaWingLee9/SpatialOmics_PanCancer/blob/main/spatial_functiions.R')

# LR interaction score of spots (without considering neighbouring spots)
# exp_mat: gene expression profile
# lr_ls: list of LR pairs (https://github.com/KaWingLee9/SpatialOmics_PanCancer/blob/main/CCI_CellChat.rds, https://github.com/KaWingLee9/SpatialOmics_PanCancer/blob/main/CCI_CellPhoneDB.rds)
# min_spot: include features detected in at least this many spots
...
# exp_mat, exp_mat_w: raw and spatial weighted gene expression profile; spatial weighted gene expression could be generated by spatialweighted_exp in this file
# lr_ls: list of LR pairs (https://github.com/KaWingLee9/SpatialOmics_PanCancer/blob/main/CCI_CellChat.rds, https://github.com/KaWingLee9/SpatialOmics_PanCancer/blob/main/CCI_CellPhoneDB.rds)
# min_spot: include features detected in at least this many spots
...
# seurat_obj
# n: considering the rounds of the spots outside as neighbours
# assay: assay to get gene expression
# new_assay: assay to return the result
# ncores: threads for analysis
# within_domain: whether considering the neighouring spots of the same domain
# domain_label: column name in seurat_obj marks the spatial domain of the spots
spatialweighted_exp=function(seurat_obj,n=1,
                             assay='RNA',new_assay='weighted',
                             ncores=20,within_domain=TRUE,domain_label='Niche'){
    ...
    if (within_domain){
        coord_df[,'Niche_node_1']=seurat_obj@meta.data[ coord_df[,'Edge_1'] , domain_label ]
        coord_df[,'Niche_node_2']=seurat_obj@meta.data[ coord_df[,'Edge_2'] , domain_label ]
...
# review version
# exp_mat_w=seurat_obj@assays$weighted@data
